...
<template>
  <div class="social-links bg-white rounded-lg shadow-md p-6">
    ...
    <div class="flex flex-wrap gap-4">
      <a
        ...
        class="social-link flex items-center gap-2 px-4 py-2 rounded-lg border-2 hover:scale-105 transition-all"
        :style="{
          borderColor: getPlatformIcon(link.platform)?.color || '#6B7280',
          color: getPlatformIcon(link.platform)?.color || '#6B7280'
        }"
      >
        <svg 
          class="w-6 h-6" 
          :viewBox="getPlatformIcon(link.platform)?.viewBox"
          fill="currentColor"
        >
